...
<div className="sale-page" style={{width:"90%",marginLeft:"5%"}}>
  {/* Sale Header */}
  <section className="sale-header">
    <div className="container">
      <div className="sale-hero">
        <div className="sale-content">
          <div className="sale-badge" style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
            <Flame size={20} /> MEGA SALE
          </div>
    ...
    <div className="container">
      <div className="benefits-grid">
        <div className="benefit-item">
          <div className="benefit-icon" style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            <Truck size={24} />
          </div>

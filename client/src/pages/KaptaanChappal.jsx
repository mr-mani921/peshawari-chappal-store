...
import { Crown, Zap, Target, Building, User, Shield, Sparkles, Trophy } from 'lucide-react';
    ...
    <div className="container">
      ...
      <div className="features-grid">
        <div className="feature-card">
          <div className="feature-icon"><Crown size={24} /></div>
